                    ...
                    <div class="table-responsive">
                        <table id="tabel-data" class="table table-bordered table-bordered dt-responsive nowrap">
                            ...
                            <tbody>
                                ...
                                $query = mysqli_query($conn, "SELECT SUM(jumlah) AS total, kode_produk, nama_produk, tanggal_masuk, harga_beli FROM v_pembelian $kondisi GROUP BY kode_produk ORDER BY tanggal_masuk DESC ");
