                    ...
                    <div class="table-responsive">
                        <table id="tabel-data" class="table table-bordered table-bordered dt-responsive nowrap">
                            ...
                            <tbody>
                                ...
                                $query = mysqli_query($conn, "SELECT SUM(jumlah) AS total, kode_produk, nama_produk, tanggal_penjualan, harga_jual FROM v_penjualan $kondisi GROUP BY kode_produk ORDER BY `id_penjualan` DESC");
